        ...
        VStack(spacing: 0) {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 32) {
                    ...
                    VStack(spacing: 20) {
                        inputField(title: "Họ và tên", text: $name, placeholder: "Họ và tên", icon: "person")
                        inputField(title: "Địa chỉ Email", text: $email, placeholder: "Địa chỉ Email", icon: "envelope")
                    }
